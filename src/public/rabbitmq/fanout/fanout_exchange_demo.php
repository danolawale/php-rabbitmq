...
<?php
    if ($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        $registrationService = new \Library\Services\RabbitMq\Fanout\RegistrationService(
        ...
        //check rabbitmq..message should be published to all bound queues
    }
    ...
    <body>
        ...
        <div class="card bg-light">
            <article class="card-body mx-auto" style="max-width: 950px;">
                ...
                <form method="POST" action="fanout_exchange_demo.php">
                     <div class="form-row">
